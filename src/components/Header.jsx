...
const Header = (props) => {
  ...
  return(
    ...
    <Switch>
      <NavLink  className='navbar-about-text' onClick={props.onFadeOut} onMouseEnter={removeChange} style={{ textDecoration: 'none', fontSize: '1.3rem', marginBottom: '90px', marginRight: '5rem',fontWeight: 'bold' }} to="/">Home</NavLink>
    </Switch>
